...
const CRMComplaints = () => {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-6">{t("CRM Complaints")}</h1>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent>
                        {updateAbility && (
                          <DropdownMenuItem
                            onClick={() => setEditDialogOpen(true) || setselectedRecord(task)}
                          >
                        ...
                        {deleteAbility && (
                          <DropdownMenuItem
                            onClick={() => setDeleteAlert(true) || setselectedRecord(task)}
                          >
