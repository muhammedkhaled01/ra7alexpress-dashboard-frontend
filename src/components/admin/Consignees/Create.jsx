...
function Create({ onSubmitSuccess }) {
  ...
  const validateForm = (form) => {
    const newErrors = {
      ...
      governorate_id: countryValue?.label === "Egypt" && !form.get('governorate_id') ? t('Governorate is required for Egypt') : '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosMerchant.post(`consignees/store`, form);
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 mt-2">
            ...
            <div className="input-container">
              ...
              <Input id="email" name="email" type="email" placeholder={t("Enter Email")} error={errors.email} />
              {errors.email && (
            ...
            <div className="input-container">
              ...
              <Input id="district" name="district" type="text" placeholder={t("Enter District")} />
            </div>
            <div className="input-container">
              <label htmlFor="zipcode">{t("Zip Code")}</label>
              <Input id="zipcode" name="zipcode" type="text" placeholder={t("Enter Zip Code")} />
            </div>
            {/* <div className="input-container">
          ...
          <div className="grid sm:grid-cols-1 lg:grid-cols-3 gap-4 mt-2">
            ...
            <div className="input-container">
              <label htmlFor="governorate_id">{t("Governorate")} {countryValue?.label === "Egypt" && <RequiredField />}</label>
              <Select
                name="governorate_id"
          ...
          <div className="input-container mt-4 mb-4">
            ...
            <Input id="streetAddress" name="streetAddress" type="text" placeholder={t("Enter Street Address")} error={errors.streetAddress} />
