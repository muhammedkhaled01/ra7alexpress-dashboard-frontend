...
function MerchantInvoicesPending() {
  ...
  const fetchData = () => {
    setLoading(true)
    axiosMerchant.get("invoices/pending_user_invoice/" + params.id).then((response) => {
  ...
  //     const response = await axiosMerchant.get(`invoices/print_pending_user_invoice/${merchant.id}`);
...
export default MerchantInvoicesPending;