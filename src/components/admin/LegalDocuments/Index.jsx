          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>{t("Document Name")}</TableHead>
                <TableHead>{t("Type")}</TableHead>
                <TableHead>{t("File Preview")}</TableHead>
            ...
            <TableBody>
              {documents.map((document, index) => {
                ...
                return (
                  <TableRow 
                    key={document.id}
                    className={isExpired ? 'bg-red-50 dark:bg-red-900/10' : isExpiringSoon ? 'bg-yellow-50 dark:bg-yellow-900/10' : ''}
                  >
                    ...
                    <TableCell>
                      <span className={isExpiringSoon ? 'text-yellow-600 dark:text-yellow-400' : isExpired ? 'text-red-600 dark:text-red-400' : ''}>
                    ...
                    <TableCell>
                      <Badge variant={
                        ...
                        document.status === 'expiring_soon' ? 'secondary' : 
                        'destructive'
                      }>
                        {document.status === 'valid' ? t('Valid') : 
                         document.status === 'expiring_soon' ? t('Expiring Soon') : 
                         t('Expired')}
                      </Badge>
                    </TableCell>
