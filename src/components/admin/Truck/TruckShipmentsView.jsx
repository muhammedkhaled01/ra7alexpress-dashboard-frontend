                        ...
                        <table className="min-w-full  ">
                            <thead>
                                <tr className="font-bold">
                                    ...
                                    <td className="px-4 py-2 border-b">{t("Loaded at")}</td>
                            ...
                            <tbody>
                                {record?.map((shipment, index) => {
                                    return <tr key={index}>
                                        ...
                                        <td className="px-4 py-2 border-b">{consigneeAddress(shipment.shipment.consignee)}</td>
                                        <td><Badge>{capitalize(shipment.status)}</Badge></td>
                                        <td className="px-4 py-2 border-b">{new Date(shipment.loaded_at).toLocaleString()}</td>
