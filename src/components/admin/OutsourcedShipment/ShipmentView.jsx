...
function ShipmentView({ shipment: _shipment, isOpen, setIsOpen, onClose }) {
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                    ...
                    <Table>
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell className="text-right">
                            {shipment?.consignee?.location_url || "-"}
                          </TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
              ...
              {shipment && shipment.consignee && shipment.consignee.old_address && (
                <Card>
                  <CardHeader>
                    <CardTitle>{shipment.consignee.old_address.approved ? t("Previous Address") : t("Requested Address") + (shipment.consignee.old_address.rejected ? t(" - Rejected") : t(" - Approved"))}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <Table>
                      <TableBody>
                    ...
                    <Table>
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell>{shipment.consignee.old_address?.comments || "-"}</TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
                  </CardContent>
